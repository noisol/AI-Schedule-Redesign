...
사용자가 현재 일정과 상황을 입력하면 AI가 가능한 범위에서 최대 3가지 재설계안을 제안합니다. 사용자는 기존 일정과 변경 내용을 비교한 뒤 원하는 안만 선택해 적용하거나, 적용한 결과를 다시 되돌릴 수 있습니다.
...
AI 응답은 `options` 배열에 1~3개의 재설계안을 포함하며, 각 안에는 전체 재설계 일정과 실제 변경 내역이 들어갑니다.
